...
export function BalanceCards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <Card className="group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-gradient-to-br from-purple-50 via-purple-100/50 to-white dark:from-purple-950/20 dark:via-purple-900/10 dark:to-background border-2 relative overflow-hidden backdrop-blur-xl">
        ...
        <CardHeader className="space-y-4 relative">
          ...
          <div className="space-y-1">
            <p className="text-5xl font-bold tracking-tight group-hover:scale-105 transition-transform duration-300 relative">
          ...
          <Button
            variant="ghost"
            className="w-full mt-2 bg-purple-500/10 hover:bg-purple-500/20 text-purple-700 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 transition-colors group-hover:scale-105"
          >
      ...
      <Card className="group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-gradient-to-br from-blue-50 via-blue-100/50 to-white dark:from-blue-950/20 dark:via-blue-900/10 dark:to-background border-2 relative overflow-hidden backdrop-blur-xl">
        <div className="absolute inset-0 bg-grid-black/[0.02] dark:bg-grid-white/[0.02] group-hover:bg-grid-black/[0.03] dark:group-hover:bg-grid-white/[0.03] transition-colors" />
        ...
        <CardHeader className="space-y-4 relative">
          ...
          <Button
            variant="ghost"
            className="w-full mt-2 bg-blue-500/10 hover:bg-blue-500/20 text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors group-hover:scale-105"
          >
            <span className="mr-2">↑</span> Withdraw
          </Button>
        </CardHeader>
      ...
      <Card className="group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-gradient-to-br from-green-50 via-green-100/50 to-white dark:from-green-950/20 dark:via-green-900/10 dark:to-background border-2 relative overflow-hidden backdrop-blur-xl">
        <div className="absolute inset-0 bg-grid-black/[0.02] dark:bg-grid-white/[0.02] group-hover:bg-grid-black/[0.03] dark:group-hover:bg-grid-white/[0.03] transition-colors" />
        ...
        <CardHeader className="space-y-4 relative">
          ...
          <Button
            variant="ghost"
            className="w-full mt-2 bg-green-500/10 hover:bg-green-500/20 text-green-700 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300 transition-colors group-hover:scale-105"
          >
            <span className="mr-2">↑</span> Withdraw
          </Button>
        </CardHeader>
